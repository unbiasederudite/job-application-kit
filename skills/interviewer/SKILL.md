...
- `data/fact-base.md` — the user's career record. Expect one heading per role/project. Read it first; new material gets appended into the right place — see "What to produce" and "Conflicts and gaps" below for where and how.
...
Once you have what you need, match the file's existing structure exactly — whatever section the item belongs to:
